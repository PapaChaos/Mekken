...
public class Damage_mine : MonoBehaviour
{
    ...
    private void OnTriggerStay(Collider other)
    {
        ...
        if (other.tag == "Player")
        {
            ...
            else
            {
                ...
                other.transform.GetComponent<damage>().doDamage(2);
                other.transform.GetComponent<playerPhysics>().velocity *= 0;
                other.transform.GetComponent<playerMotion>().applyImpulseForce(Vector3.up * 100000.0f);
            }
        }
    }
